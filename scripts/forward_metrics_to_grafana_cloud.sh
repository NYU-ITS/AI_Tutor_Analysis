...
QUALITY_PROMETHEUS_CONFIG_PATH="${QUALITY_PROMETHEUS_CONFIG_PATH:-/tmp/ai-tutor-grafana-cloud-prometheus.yml}"
...
docker_args=(
  run
  --rm
  -v "${QUALITY_PROMETHEUS_CONFIG_PATH}:/etc/prometheus/prometheus.yml:ro"
  "${PROMETHEUS_IMAGE}"
